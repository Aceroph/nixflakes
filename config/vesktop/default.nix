    ...
    vencord.themes = {
      scomb-midnight = ''
        ...
        :root {
            ...
            --text-4: var(--text-muted); /* icon buttons and channels */
            ...
            /* accent colors */
            --accent-1: var(--primary); /* links and other accent text */
            --accent-2: var(--primary); /* small accent elements */
            --accent-3: var(--primary); /* accent buttons */
            --accent-4: var(--primary); /* accent buttons when hovered */
            --accent-5: var(--primary); /* accent buttons when clicked */
